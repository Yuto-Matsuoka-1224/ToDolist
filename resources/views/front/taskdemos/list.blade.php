...
<div class="card-body">
    ...
    <div style="position:absolute; top:12px; right:25px;">
        <a href='/taskdemos/complete'>完了したタスクはこちら</a>
    </div>
    ...
    <table class="table table-striped table-bordered table-hover table-sm">
        ...
        <tr>
             <td style="vertical-align: middle;">{{ $taskdemo->title }}</td>
             <td style="text-align: center; vertical-align: middle;">{{ $taskdemo->realtime_hours }}時間{{ $taskdemo->realtime_minutes }}分</td>  <!-- カラム名を中央に表示 -->
             ...
             <td class="d-flex justify-content-center">
                ...
                {{ Form::model($taskdemo, [
                     'route' => ['front.taskdemos.destroy', $taskdemo],
                     'method' => 'delete'
                ]) }}
                 {{ Form::submit('削除', [
